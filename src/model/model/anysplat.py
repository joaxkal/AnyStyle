...
class AnySplat(nn.Module, huggingface_hub.PyTorchModelHubMixin):
    ...
    def inference(self,
        ...
        encoder_output = self.encoder(context_image, global_step=0, visualization_dump=None, style_dir=style_dir)
    ...
    def forward(self, 
        ...
        encoder_output = self.encoder(context_image, global_step, visualization_dump=visualization_dump, style_dir=style_dir)
        gaussians, pred_context_pose = encoder_output.gaussians, encoder_output.pred_context_pose
