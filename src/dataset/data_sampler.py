    ...
    def __iter__(self):
        ...
        while True:
            try:
                ...
                batch_size = min(self.max_img_per_gpu / random_image_num, self.max_batch_size)
...
class MixedBatchSampler(BatchSampler):
    ...
    def __init__(
        self, src_dataset_ls, batch_size, num_context_views, world_size=1, rank=0, prob=None, sampler=None, generator=None, max_batch_size=100000000
    ):
